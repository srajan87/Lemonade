...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        // Determine which Test to set for the Text View
        val textActiontext = when (lemonadeState) {
        ...
        // Set text value for textAction Text View
        textAction.setText(textActiontext)

        // Determine which Drawable Resource ID based on the current state
        ...
        // Set correct image to load based on the current state
        imageLemonState.setImageResource(drawableResource)
    }
